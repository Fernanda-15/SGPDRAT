...
=======
var isInternalWorkerThread = ((_a = worker_threads == null ? void 0 : worker_threads.workerData) == null ? void 0 : _a.esbuildVersion) === "0.13.12";
>>>>>>> main
...
=======
  let child = child_process.spawn(command, args.concat(`--service=${"0.13.12"}`, "--ping"), {
>>>>>>> main
    windowsHide: true,
...
=======
  ...
  callback(service);
  let stdout = child_process.execFileSync(command, args.concat(`--service=${"0.13.12"}`), {
>>>>>>> main
    cwd: defaultWD,
    windowsHide: true,
    input: stdin,
...
=======
    workerData: { workerPort, defaultWD, esbuildVersion: "0.13.12" },
>>>>>>> main
