...
=======
  ...
  if (stdout !== "0.13.12") {
    throw new Error(`Expected ${JSON.stringify("0.13.12")} but got ${JSON.stringify(stdout)}`);
>>>>>>> main
  }
}
function isYarn() {
...
=======
    child_process.execSync(`npm install --loglevel=error --prefer-offline --no-audit --progress=false ${pkg}@${"0.13.12"}`, { cwd: installDir, stdio: "pipe", env });
>>>>>>> main
...
=======
  const url = `https://registry.npmjs.org/${pkg}/-/${pkg}-${"0.13.12"}.tgz`;
>>>>>>> main
