        ...
        t.selectedCells = [], t.topSelectedCell = null, t.bottomSelectedCell = null, t.selecting = !1, t.column = null, t.firstSelected = null, t.firstMousePos = null, t.originalMouse = null, t.originalHeight = null, t.originalTop = null, t.resizing = null, t.globalHandlers = !1, t.moving = null, t.register = function (e) { t.registered || (t.registered = []); for (var i = t.registered, n = 0; n < i.length; n++)
            ...
            this.o = function (e, t) { if (e && 0 === e.indexOf("$$$")) {
                ...
                for (var i in e.Hashes)
                    s.hashes[i] = e.Hashes[i]; s.events.list = e.Events, s.C(), s.D(), "Full" === e.UpdateType && (s.E(), s.F(), s.G(), s.H()), s.A(), s.I(), s.clearSelection(), s.afterRender(e.CallBackData, !0), s.loadingStop(); }, this.J = function () { return this.K() / 36e5; }, this.L = function () { return this.businessBeginsHour > this.businessEndsHour ? 24 - this.businessBeginsHour + this.businessEndsHour : this.businessEndsHour - this.businessBeginsHour; }, this.M = function () { return this.K() / 18e5; }, this.K = function () { var e = 0; return e = "BusinessHoursNoScroll" === this.heightSpec ? this.L() : 24, 60 * e * 60 * 1e3; }, this.N = function () { return "BusinessHoursNoScroll" === this.heightSpec ? this.businessBeginsHour : 0; }, this.O = function () { return 2 === s.api; }, this.eventClickCallBack = function (e, t) { this.m("EventClick", t, e); }, this.eventClickPostBack = function (e, t) { this.k("EventClick", t, e); }, this.P = function (e) { var t = this, i = t.event; if (s.O()) {
                var n = {};
                ...
                } }, this.S = function (e) { if (!t.selecting && "Disabled" !== s.timeRangeSelectedHandling) {
            ...
            } }, this.T = function () { this.getSelection(); !function () { return; }(), function () { var e = t.topSelectedCell, i = t.bottomSelectedCell, n = function () { if (e.data)
            ...
            } }(); }, this.U = function (e) { if ("undefined" != typeof t && t.selecting) {
            ...
            } }, this.getSelection = function () { var e = t.topSelectedCell.start, i = t.bottomSelectedCell.end; return new DayPilot.Selection(e, i, null, s); }, this.V = function (e) { }, this.W = function (e) { if (e < 0)
                ...
                return null; e.x = s.W(s.coords.x); var t = 0, i = Math.floor((s.coords.y - t) / s.cellHeight); return e.y = i, e.x < 0 ? null : e; }, this.B = function () { "Resources" !== s.viewType && (this.columns = this.Y()); for (var e = 0; e < this.columns.length; e++)
                this.Z(this.columns[e]); }, this.Z = function (e) { e.start = new DayPilot.Date(e.start), e.putIntoBlock = function (e) { for (var t = 0; t < this.blocks.length; t++) {
                var i = this.blocks[t];
                ...
                if (!(i < a.part.top || e > a.part.top + a.part.height - 1))
                    return !1;
            } return !0; }, i.push(e), this.lines.push(i), this.lines.length - 1; }; }, this.Y = function () { var e = [], t = this.startDate.getDatePart(), i = this.days; switch (this.viewType) {
                case "Day":
                    i = 1;
                    break;
                case "Week":
            ...
            } s.elements.events.push(a); }, this._ = function (e) { for (var t = e && e.childNodes ? e.childNodes.length : 0, i = 0; i < t; i++)
                try {
            ...
            }, this.ka = function (e, t) { return this.businessBeginsHour < this.businessEndsHour ? !(e.getHours() < this.businessBeginsHour || e.getHours() >= this.businessEndsHour || 6 === e.getDayOfWeek() || 0 === e.getDayOfWeek()) : e.getHours() >= this.businessBeginsHour || e.getHours() < this.businessEndsHour; }, this.r = function () { var e = this.nav.header; if (e && e.rows)
                for (var t = 0; t < e.rows.length; t++)
                    for (var i = e.rows[t], n = 0; n < i.cells.length; n++) {
                        var s = i.cells[n];
                        s.onclick = null, s.onmousemove = null, s.onmouseout = null;
                    } this.fasterDispose || DayPilot.pu(e); }, this.la = function (e) { for (var t = e ? this.nav.header.insertRow(-1) : this.nav.header.rows[0], i = this.columns, n = i.length, a = 0; a < n; a++) {
            ...
            } s.update(), s.Q.notify(); }, this.events.remove = function (e) { var t; if (e instanceof DayPilot.Event)
                t = e.data;
            else if ("object" == typeof e) {
                ...
                i && (t = i.data);
            } var n = DayPilot.indexOf(s.events.list, t); s.events.list.splice(n, 1), s.update(), s.Q.notify(); }, this.events.load = function (e, t, i) { var n = function (e) { var t = {}; t.exception = e.exception, t.request = e.request, "function" == typeof i && i(t); }, a = function (e) { var i, a = e.request; try {
            ...
            } }, this.update = function (e) { s.ua(e), s.va(), s.p(), s.nav.top.style.cursor = "auto"; s.B(), s.E(), s.F(), s.G(), s.H(), s.ia(), s.wa(), s.C(), s.D(), s.A(), s.I(), s.clearSelection(), this.visible ? this.show() : this.hide(); }, this.xa = null, this.ua = function (e) { if (e) {
            ...
            for (name in e)
                i[name] = e[name];
            i.init(), t || (t = i);
        } }); return 1 === this.length ? t : i; }; }(jQuery), function () { var e = DayPilot.am(); e && e.directive("daypilotCalendar", ["$parse", function (e) { return { "restrict": "E", "template": "<div></div>", "replace": !0, "link": function (t, i, n) { var s = new DayPilot.Calendar(i[0]); s.Q.scope = t, s.init(); var a = n["id"]; a && (t[a] = s); var l = n["publishAs"]; if (l) {
                    (0, e(l).assign)(t, s);
                } for (var o in n)
...
"undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), function () { if ("undefined" == typeof DayPilot.Navigator || !DayPilot.Navigator.nav) {
    ...
    } o && i.freeHandSelectionEnabled ? i.selectionEnd = new DayPilot.Date(o) : this.u(), this.f(), this.b(), this.C(), this.s(), this.t(), !c || d.equals(this.selectionStart) && u.equals(this.selectionEnd) || this.D(), f && this.E(); }, this.update = function (t) { if (!i.z)
